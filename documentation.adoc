...
[cols="a,a"]
|====
| image::insert_resistor.jpg[320,240] | Insert resistors as depecited and printed as R1 and R2 on the board’s silk screen
|====
...
[cols="a,a"]
|====
| image::solder_resistors_and_cut_wire.jpg[320,240] | Trim the leads after soldering using the side-cutting pliers.
|====
...
[cols="a,a"]
|====
| image::insert_electrolytic_cap.jpg[320,240] | Insert the ceramic capacitor first as it has a lower profile. Again, make sure that the capacitor is soldered very close to the board. The capacitor must be laid on its side since the nano board will be mounted above it.
|====
...
[cols="a,a"]
|====
| image::insert_slide_switch.jpg[320,240] | Insert slide switch
|====
...
[cols="a,a"]
|====
| image::insert_pinheader.jpg[320,240] | The pinheader should be inserted in the bottom of the ardunio board
|====
