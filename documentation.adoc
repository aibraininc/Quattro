...
==== Step 5.1 Attach the cables that connect battery to PCB Board 
Need to watchout for -/+ of the cable
Need picture taht shows which is +/- 

==== Step 5.2 Add battery to the frame

==== Step 5.3 Attach the servo motor cable
Need to make sure the cable is in the right driection, brown first 
Need to test if the power can be turned on

==== Step 5.4 Attach mid-body+upper-body with lower body
Need to watchout taht servo motor should be att eh btom
...
=======
>>>>>>> 4faaa2e3e640d54069ae32418aacaed4a2c3df90
