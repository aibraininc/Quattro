...
|====
2+| *Tools*
| Soldering iron, solder, <br> glue, scissors, <br> wire stripper, snipper, <br> long nose piler | image::IMG_0781.JPG[320,240]
|====
...
|====
2+| *Tools*
| <ul><li>item1</li><li>item2</li></ul>  | image::IMG_0780.JPG[320,240]
|====
