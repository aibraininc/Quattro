...
video::fO54vNBzYJA[youtube]
link:https://www.youtube.com/watch?v=fO54vNBzYJA[Step 1.1 Attach servo motor with battery frame]
...
2.3.2 Pull the wire and bend it.

2.3.3 Solder

2.3.4 Cut the excess wires
...
2.4.1 Insert tatile switch

2.4.2 Solder

2.4.3 Insert slid switch

2.4.4 Pull the wire and bend it.

2.4.5 Solder

2.4.6 Cut the excess wires

==== Step 2.5 Solder pinhead
[cols="a,a"]
|====
| *Before* | *After*
| image::IMG_0713.JPG[320,240] | image::IMG_0714.JPG[320,240]
...
2.5.1 Insert pinhead

2.5.2 Solder


==== Step 2.6 Solder potentiometer
...
2.6.1 Bend the potentiometer

2.6.2 Insert potentiometer

2.6.3 Pull the wire and bend it.

2.6.4 Solder

2.6.5 Cut the excess wires

==== Step 2.7 Label the potentiometer
...
==== Step 2.8 Solder cable for ultersonic sensr
[cols="a,a"]
|====
| *Before* | *After*
...
2.8.2 Cut the skin of the cable

2.8.3 Solder the raw cable to the PCB Board
